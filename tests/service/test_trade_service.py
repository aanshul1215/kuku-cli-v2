...
from app.service.trade_service import execute_purchase_order, InsufficientFundsError, TradeExecutionException
...
def test_execute_order_for_nonexistent_security(setup, db_session):
    ...
    with patch('app.service.trade_service.get_quote') as mock_get_quote:
        ...
        assert "Security with ticker INVALID does not exist or data unavailable." in str(e.value)